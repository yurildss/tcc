...
# split_dataset.py
# =============================================================================
# Divide o dataset aumentado em train / val / test de forma estratificada
# (mesma proporção de classes em cada split).
#
# ESTRUTURA DE ENTRADA:
#   dataset_aumentado/
#     <classe>/
#       *.csv   (originais + aumentados misturados)
#
# ESTRUTURA DE SAÍDA:
#   dataset_split/
#     train/<classe>/*.csv
...
#     test/<classe>/*.csv
#
# PROPORCOES PADRÃO (ajustáveis abaixo):
#   train : 70%
#   val   : 15%
#   test  : 15%
#
# REGRA IMPORTANTE:
#   Arquivos aumentados (_aug_) NUNCA vão para val nem test.
#   Val e test usam SOMENTE originais, garantindo avaliação sem
#   contaminação por dados sintéticos.
# =============================================================================
